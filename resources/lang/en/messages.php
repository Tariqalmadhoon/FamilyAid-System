...
return [
    ...
    'citizen' => [
        ...
        'update_household_sub' => 'Edit head name, address, and contact info',
        ...
        'head_name_section_title' => 'Update Head of Household Name',
        'head_name_section_hint' => 'The account owner can update the household head name here only once per month. Every change is recorded in the audit log to protect data integrity.',
        'head_name_placeholder' => 'Enter the approved full name',
        'head_name_update_available' => 'Update available now',
        'head_name_update_locked_badge' => 'Locked for this month',
        'head_name_national_id_notice' => 'The head-of-household national ID is fixed and cannot be changed from this screen: :national_id',
        'head_name_last_updated_at' => 'Last self-service name update: :date',
        'head_name_next_rule_hint' => 'After saving a new name, another self-service change will not be available until the next month starts.',
        'head_name_locked_until' => 'You can update the name again starting on: :date',
        'head_name_update_locked_error' => 'The monthly self-service update for the household head name has already been used. Next allowed date: :date',
        'household_update_success' => 'Household information updated successfully.',
    ],
    ...
    'onboarding_form' => [
        ...
        'spouse_toggle_has' => 'I have a spouse',
        'spouse_toggle_none' => 'No spouse (Single)',
        'spouse_none_badge' => 'Registration marked as no spouse',
        'spouse_none_helper' => 'You can continue without filling spouse details, and the registration will be treated as single.',
        'spouse_none_summary' => 'No spouse (Single)',
