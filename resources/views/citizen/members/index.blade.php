                ...
                <div class="flex items-start justify-between gap-4">
                    ...
                    <div class="shrink-0 self-start">
                        <a
                            ...
                            class="inline-flex min-w-[108px] items-center justify-center gap-2 rounded-lg border border-teal-200 bg-teal-50 px-3 py-2 text-sm font-semibold text-teal-700 transition hover:bg-teal-100 hover:border-teal-300"
                        >
                            <span class="inline-flex h-6 w-6 items-center justify-center rounded-full bg-white text-teal-700 shadow-sm">
