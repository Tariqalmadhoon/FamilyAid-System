        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center {{ app()->getLocale() === 'ar' ? 'sm:mr-6' : 'sm:ml-6' }} gap-3">
                ...
                <x-dropdown :align="app()->getLocale() === 'ar' ? 'left' : 'right'" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('account.security.edit')">
                            {{ __('messages.account_security.menu') }}
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('account.security.edit')" :active="request()->routeIs('account.security.*')">
                    {{ __('messages.account_security.menu') }}
                </x-responsive-nav-link>
